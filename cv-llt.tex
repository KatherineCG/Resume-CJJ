...
\myname{Jingjie Chen}{Jingjie\bibnamedelima Chen}
...
\leftheader{%
  {\LARGE\bfseries\sffamily Jingjie Chen}
  
  \makefield{\faBirthdayCake}{\texttt{1995-03-28}}
  
  \makefield{\faPhoneSquare}{\texttt{(+86)132-6418-1725}}
  
  \makefield{\faEnvelopeO}{\texttt{chenjingjie@bupt.edu.cn}}
}
